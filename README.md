...
For Drupal 11 (IOHO less stable) please follow the [Archipelago 2.1.0 Deployment Live](https://github.com/esmero/archipelago-deployment-live/blob/2.1.0/README.md) guide. Same features but different code (and more work for us!).


Last updated: Sept 16th 2026. Replaces "gone" minio/minio with gateway support with our own built from scratch.

Previously updated: Jun 17th 2026 for Drupal 10.6.11 and Archipelago 1.7.0 (and 2.1.0) release day!

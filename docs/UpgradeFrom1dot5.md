...
from the new release and, as described in the general (from zero) [1.6.0 Deployment Instructions](../README.md) replace the `http://esmero-web` with your real domain.
...
And selectively copy images/enviromentals into your production `docker-compose.yml` file. Please also read and use [General Installation guide for 1.6.0](../README.md) to ensure you are using the right, and new, `.env` enviromentals. Basically have it at hand to validate all your changes.
